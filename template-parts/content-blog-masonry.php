<article id="post-<?php the_ID(); ?>" <?php post_class( 'brick' ); ?>>
	...
	<div class="dates"><?php echo esc_html( get_the_date( get_option( 'date_format' ) ) ); ?></div>
	<!-- .entry-header -->
			...
			<div class="col-xs-6">
				<?php if ( 'post' == get_post_type() ) : ?>
					<div class="entry-meta">
						<span class="comments-counts"><span
								class="fa fa-comment-o"></span><?php comments_number( '0', '1', '%' ); ?> <?php comments_number( 'comment', 'Comment', 'Comments' ); ?></span>
					</div><!-- .entry-meta -->
				<?php endif; ?>
			</div>
