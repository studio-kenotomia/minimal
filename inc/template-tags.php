...
if ( ! function_exists( 'infinity_paging_nav' ) ) :
	...
	function infinity_paging_nav() {
		...
		$links = paginate_links( array(
			...
			'prev_text' => esc_html__( '&larr; Previous', 'infinity' ),
			'next_text' => esc_html__( 'Next &rarr;', 'infinity' ),
		) );
		...
		if ( $links ) :
			...
			<div class="pagination loop-pagination">
				<?php echo wp_kses( $links , wp_kses_allowed_html( 'post' ) ); ?>
			</div><!-- .pagination -->
			<?php
		endif;
	}
...
if ( ! function_exists( 'the_archive_title' ) ) :
	...
	function the_archive_title( $before = '', $after = '' ) {
		...
		if ( ! empty( $title ) ) {
			echo wp_kses( $before . $title . $after , wp_kses_allowed_html( 'post' ) );  // WPCS: XSS OK.
		}
	}
endif;
...
if ( ! function_exists( 'the_archive_description' ) ) :
	...
	function the_archive_description( $before = '', $after = '' ) {
		...
		if ( ! empty( $description ) ) {
			 ...
			 */
			echo wp_kses( $before . $description . $after , wp_kses_allowed_html( 'post' ) );  // WPCS: XSS OK.
		}
	}
endif;
