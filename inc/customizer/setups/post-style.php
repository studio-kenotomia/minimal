...
Kirki::add_field( 'infinity', array(
	...
	'output'    => array(
		array(
			'element'  => '.big-title--single .entry-title, .big-title--single .entry-desc, .title--single .entry-title, .title--single .entry-desc',
			'property' => 'color',
		),
	),
) );
...
Kirki::add_field( 'infinity', array(
	'type'      => 'select',
	'setting'   => 'post_style_heading_text_align',
	...
	'output'    => array(
		'element'  => '.big-title--single.big-title, .big-title--single.big-title *',
		'property' => 'text-align'
	),
) );