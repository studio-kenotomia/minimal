...
function thememove_upgrade_notice() {
	$message = sprintf( esc_html__( 'ThemeMove requires at least WordPress version 3.9. You are running version %s. Please upgrade and try again.', 'infinity' ), $GLOBALS['wp_version'] );
...
function thememove_customize() {
	wp_die( sprintf( esc_html__( 'ThemeMove requires at least WordPress version 3.9. You are running version %s. Please upgrade and try again.', 'infinity' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function thememove_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( esc_html__( 'ThemeMove requires at least WordPress version 3.9. You are running version %s. Please upgrade and try again.', 'infinity' ), $GLOBALS['wp_version'] ) );
	}
}
